    ...
    Promise中维护了两个隐藏的属性
        ...
        流程：
            ...
            当我们通过then读取数据时，相当于为Promise设置了回调函数：
                如果PromiseState 变为fulfilled，则调用then的第一个回调函数来返回数据
                如果PromiseState 变为rejected，则调用then的第二个回调函数来返回数据
